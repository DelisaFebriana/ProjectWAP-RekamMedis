        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="nama" class="form-control" id="nama" placeholder="nama obat" value="<?= $obat['nama'] ?>" required>
                </div>
                <div class="form-group mb-3">
                    <label for="kegunaan" class="form-label">Kegunaan</label>
                    <textarea name="kegunaan" id="kegunaan" cols="" rows="" class="form-control" placeholder="kegunaan obat" required><?= $obat['kegunaa'] ?></textarea>
                </div>
