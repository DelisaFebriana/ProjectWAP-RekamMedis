...
if ($dataUser['jabatan'] == 3) {
  ...
  if ($msg == 'updated') {
    $alert= '<div class="alert alert-succes alert-dismissible fade show updated" role="alert">
...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      ...
      class="btn btn-outline-secondary btn-sm mb-3 " title="tambah obat baru"><i class="bi bi-plus-lg align-top"></i>Obat Baru</a>
            ...
            while ($obat = mysqli_fetch_assoc($queryObat)) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="proses-obat.php?id=<?= $obat['id'] ?>&aksi=hapus-obat" onclick="return confirm('Anda yakin akan menghapus obat ini ?')" class="btn btn-sm btn-outline-danger" title="hapus obat"><i class="bi bi-trash align-top"></i></a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
