...
<link href="<?= $main_url ?>asset/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      ...
      #bg-login{
        background-image: url(../asset/gambar/bg-klinik.jpg);
...
<main class="form-signin w-100 m-auto">
  <form action="proses-login.php" method="post">
    ...
    <h1 class="h3 mb-4 fw-normal">Rekam Medis</h1>
    ...
    <p class="mt-5 mb-3 text-white">&copy; 2023 Rekam Medis</p>
  </form>
</main>
