      ...
      <form action="proses-user.php" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-4 mb-4 text-center">
                <div class="px-4 mb-4">
                    <img src="<?= $main_url ?>asset/gambar/user.png" alt="user"
                ...
                class="bi bi-save align-top"></i> Simpan</button>
            </div>
            <div class="col-lg-8">
                ...
                <div class="form-group mb-3">
                    ...
                    id="fullname" placeholder="masukan nama lengkap user" required>
                </div>
                <div class="form-group mb-3">
                    <label for="password" class="form-label">Password</label>
                    <input type="password" name="password" class="form-control"
                    id="password" placeholder="masukan password user" required>
                </div>
                <div class="form-group mb-3">
                    <label for="password2" class="form-label">Konfirmasi Password</label>
                    <input type="password" name="password2" class="form-control"
                    id="password2" placeholder="masukan kembali password user" required>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    class="form-control" placeholder="masukan alamat user"></textarea>
                </div>
            </div>
        </div>
      </form>
