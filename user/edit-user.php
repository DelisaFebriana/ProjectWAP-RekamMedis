        ...
        <div class="row">
            <div class="col-lg-4 mb-4 text-center">
                <div class="px-4 mb-4">
                    ...
                    <img src="<?= $main_url ?>asset/gambar/<?= $user['gambar'] ?>" alt="user"
                    class="img-thumbnail mb-3 rounded-circle tampil" width="120px"> 
                    <input type="file" class="form-control form-control-sm"
                    name="gambar" onchange="imgView()" id="gambar">
                    <span class="text-sm">Type file gambar JPG | PNG | GIF</span><br>
                    <span class="text-sm">Width = height</span>
                </div>
                <button type="submit" name="update" class="btn btn-outline-primary btn-sm"><i 
                class="bi bi-save align-top"></i> Update </button>
            </div>
            <div class="col-lg-8">
                ...
                <input type="hidden" name="usernameLama" value="<?= $user['username'] ?>">
                    ...
                    id="username" placeholder="masukan username" value="<?= $user['username'] ?>" autocomplete="off"
                    autofocus required>
                </div>
                <div class="form-group mb-3">
                    <label for="fullname" class="form-label">Fullname</label>
                    <input type="text" name="fullname" class="form-control"
                    id="fullname" value="<?= $user['fullname'] ?>" placeholder="masukan nama lengkap user" required>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="alamat" id="alamat" cols="" rows="3" 
                    class="form-control" placeholder="masukan alamat user"><?= $user['alamat'] ?></textarea>
                </div>
            </div>
        </div>
      </form>
